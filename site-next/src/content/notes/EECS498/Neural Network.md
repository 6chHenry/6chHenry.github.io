...
tags:
  - "EECS498"
draft: false
legacyPath: "/notes/EECS498/Neural Network/"
---
...
| --------------------------------------------- | ------------------------------ | ------------------------------------------------------ |
| Sigmoid                                       | $\sigma(x)=\frac{1}{1+e^{-x}}$ | ![Sigmoid Function](/assets/notes/EECS498/Neural%20Network.assets/sigma.png) |
| tanh                                          | tanh(x)                        | ![tanhx](/assets/notes/EECS498/Neural%20Network.assets/tanh.png)             |
| ReLU(A good default choice for most problems) | max(0,x)                       | ![ReLU](/assets/notes/EECS498/Neural%20Network.assets/relu.png)           |
...
but with ReLU function,![Space Warping](/assets/notes/EECS498/Neural%20Network.assets/spacewarping.jpg)

Universal Approximation:

​	use layer bias to move the graph

![UA](/assets/notes/EECS498/Neural%20Network.assets/UA.png)
