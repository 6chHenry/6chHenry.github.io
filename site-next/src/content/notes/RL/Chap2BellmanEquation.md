...
updatedAt: "2026-05-25T15:40:40.438Z"
tags:
  - "RL"
draft: false
legacyPath: "/notes/RL/Chap2BellmanEquation/"
---
# 贝尔曼公式（强化学习）核心知识点总结
## 一、贝尔曼公式基础认知
...
### 案例2：多动作、概率转移的场景
- **设定**：状态$s_1$下，策略$\pi(\text{右}\mid s_1)=0.5$、$\pi(\text{下}\mid s_1)=0.5$；向右转移到$s_2$（奖励-1），向下转移到$s_3$（奖励0）。
- **代入公式**：  
